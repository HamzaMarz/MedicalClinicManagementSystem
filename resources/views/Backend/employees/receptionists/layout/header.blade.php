    ...
    <ul class="float-right nav user-menu">
                        ...
                        @forelse(auth()->user()->unreadNotifications as $notification)
                            <li class="notification-message">
                                <a href="{{ route('description_medication', $notification->data['medication_id']) }}">
                                    <div class="media">
                                        <span class="avatar">
                                            <img alt="Doctor" src="{{ asset('assets/img/expired.png') }}" class="img-fluid">
                                        </span>
        ...
        <li class="nav-item dropdown has-arrow">
            <a href="#" class="dropdown-toggle nav-link user-link" data-toggle="dropdown">
                <span class="user-img">
                    <img class="rounded-circle" style="width: 40px; height:40px; margin-right:5px;" src="{{ asset($receptionist?->image) }}">
                </span>
                <span>
                    Receptionist
                </span>
