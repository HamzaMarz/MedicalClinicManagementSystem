        ...
        <div class="col-md-4 col-sm-4 col-lg-3">
            <div class="profile-widget">
                ...
                <h4 class="doctor-name text-ellipsis">
                    <a href="{{ Route('profile_doctor' , ['id' => $doctor->id]) }}">{{ $doctor->user->name }}</a>
                </h4>
                <div class="doc-prof">{{ $doctor->employee->department->name }}</div>
...
@else
    <div class="col-12 text-center">
        <div class="alert alert-info" style="font-weight: bold; font-size: 18px; margin-top:20px;">
            No Doctors Found
        </div>
    </div>
@endif
