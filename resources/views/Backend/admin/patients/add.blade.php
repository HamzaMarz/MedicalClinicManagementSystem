        ...
        <div class="row">
            <div class="col-lg-8 offset-lg-2">
                <form method="POST" action="{{ Route('store_patient') }}" enctype="multipart/form-data">
                    ...
                    {{-- 3) Assignment (Department/Doctor) --}}
                    <div class="card">
    ...
    <script>
        ...
        $(document).ready(function () {
            $('.addBtn').click(function (e) {
                ...
                if (name == '' || date_of_birth == '' || email == '' || password == '' || confirm_password == '' || phone == '' || address == '' || gender === undefined || !isValidSelectValue('blood_type') || emergency_contact == ''  || !isValidSelectValue('department_id') || !isValidSelectValue('doctor_id') || !isValidSelectValue('appointment_time') || !isValidSelectValue('appointment_day')) {
                    Swal.fire({
                        title: 'Error!',
        ...
        // عند اختيار الدكتور → جلب الأوقات + الأيام
