...
@section('title' , 'View Pharmacy Inventory')
    ...
    <div class="content">
        <div class="row">
            <div class="col-sm-4 col-3">
                <h4 class="page-title">View Pharmacy Inventory</h4>
            </div>
        </div>
                ...
                <div class="table-responsive">
                    <table class="table mb-0 text-center table-bordered table-striped custom-table">
                        ...
                        <tbody id="medications_table_body">
                            @if($medicationPharmacies->count() > 0)
                                @foreach ($medicationPharmacies as $med)
                                    <tr>
                                        <td>{{ $med->id }}</td>
                    ...
                    <div id="medications-pagination" class="pagination-wrapper d-flex justify-content-center">
                        {{ $medicationPharmacies->links('pagination::bootstrap-4') }}
                    </div>
                </div>
            </div>
        </div>
