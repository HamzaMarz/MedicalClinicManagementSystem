                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="date" id="date_of_birth" name="date_of_birth" class="form-control" value="{{ $user->date_of_birth }}">
                                    </div>
                                </div>
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <div class="input-group">
                                        <div class="input-group-prepend"><span class="input-group-text"><i class="fa fa-lock"></i></span></div>
                                        <input type="password" id="confirm_password" name="confirm_password" class="form-control" placeholder="Enter confirm password (optional)">
                                    </div>
                                </div>
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <div class="profile-upload">
                                        <div class="upload-img">
                                            <img alt="admin image" src="{{ $user->image ? asset($user->image) : asset('assets/img/user.jpg') }}">
                                        </div>
                                    ...
                                    <div class="form-group gender-select">
                                        ...
                                        <div class="form-check-inline">
                                            <label class="form-check-label">
                                                <input type="radio" name="gender" value="male" class="form-check-input" {{ $user->gender == 'male' ? 'checked' : '' }}>Male
                                            </label>
                                        </div>
                                        <div class="form-check-inline">
                                            <label class="form-check-label">
                                                <input type="radio" name="gender" value="female" class="form-check-input" {{ $user->gender == 'female' ? 'checked' : '' }}>Female
                                            </label>
                                        </div>
                                    </div>
                                </div>
