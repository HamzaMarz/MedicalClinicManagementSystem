...
<div class="page-wrapper">
    <div class="content">
        ...
        <div class="card-box">
            ...
            <div class="row">
                <div class="col-md-6">
                    ...
                    <p><strong>Doctors in this Specialty:</strong> {{ $count_doctors }}</p>
                </div>
            </div>
        </div>
        ...
        <div class="mb-3 d-flex justify-content-end">
            <a href="{{ route('department_manager_view_specialties') }}" class="btn btn-primary rounded-pill" style="font-weight: bold;">
                Back
            </a>
        </div>
