    ...
    <div class="header-left">
        <a href="{{ Route('department_manager_dashboard') }}" class="logo">
            <div class="d-flex align-items-center">
                <img src="{{ asset('assets/img/logo_backup.png') }}" width="35" height="35" alt="">
    ...
    <ul class="float-right nav user-menu">
                    ...
                    <ul class="notification-list">
                        @forelse(auth()->user()->unreadNotifications as $notification)
                            <li class="notification-message">
                                <a href="{{ route('description_medication', $notification->data['medication_id']) }}">
                                    <div class="media">
                                        <span class="avatar">
                                            <img alt="Department Manager" src="{{ asset('assets/img/expired.png') }}" class="img-fluid">
                                        </span>
        ...
        <li class="nav-item dropdown has-arrow">
            <a href="#" class="dropdown-toggle nav-link user-link" data-toggle="dropdown">
                <span class="user-img">
                    <img class="rounded-circle" style="width: 40px; height:40px; margin-right:5px;" src="{{ asset($department_manager?->image) }}">
                </span>
                <span>
                    Department Manager
                </span>
