$(document).ready(function () {
    ...
    // رسم Bar Chart (يتحقق أولاً إن العنصر موجود)
    ...
    // رسم Line Chart (يتحقق أولاً إن العنصر موجود)
    ...
    // Bar Chart 2 (Progress Style)
    function barChart() {
        $('.bar-chart').find('.item-progress').each(function () {
            var itemProgress = $(this),
                itemProgressWidth = $(this).parent().width() * (itemProgress.data('percent') / 100);
